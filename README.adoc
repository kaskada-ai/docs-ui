...
This repo contains the Antora UI components needed to build the Kaskada docs using antora. 
...
The base code for this project is supplied by the {url-antora-default-ui}[Antora Default UI], with Kaskada-specific components templated over the top.
...
ui:
  bundle:
    url: https://github.com/kaskada-au/docs-ui/releases/latest/download/ui-bundle.zip
    snapshot: true
----
...
Copyright (C) the Kaskada Project Authors 2023-present.
All rights reserved.